...
data = pd.read_csv(r"D:\CODES AND DATASETS\Data Mining Unsupervised Learning(Association Rules)\Data Types, EDA, Sampling,Descriptive Analytics\Data Sets\ethnic diversity.csv")
data.dtypes
...
import pandas as pd
data = pd.read_csv(r"C:\Users\pc\Desktop\data pre processing/mtcars_dup.csv")
...
df = pd.read_csv(r"C:\Users\pc\Desktop\data pre processing/ethnic diversity.csv")
df.dtypes
